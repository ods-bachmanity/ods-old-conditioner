...
var UTMSCoordinateTransform = (function (_super) {
    ...
    function UTMSCoordinateTransform(executionContext, transformDef, fieldName) {
    ...
    UTMSCoordinateTransform.prototype.fx = function () {
        var _this = this;
        var result = new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
            var nitfIGEOLO, ZONE_LENGTH, EASTING_LENGTH, NORTHING_LENGTH, COORD_LENGTH, myNewInstance, i, coordinate, parsedZone, parsedEasting, parsedNorthing, body, err_1;
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (body && body.Coordinates) {
                            ...
                            this.executionContext.transformed.Metadata.COORD_TYPE = 'S';
                            return [2, resolve(true)];
                        }
                        _a.label = 2;
    ...
    UTMSCoordinateTransform.prototype.callService = function (conversionRequest) {
        var _this = this;
        var result = new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        if (!this._servicePath) {
                            return [2, reject('Invalid Service Path for UTMS Coordinate Service')];
                        }
                        return [4, rp.post({
