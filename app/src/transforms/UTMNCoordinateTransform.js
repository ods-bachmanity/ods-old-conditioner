...
var UTMNCoordinateTransform = (function (_super) {
    ...
    function UTMNCoordinateTransform(executionContext, transformDef, fieldName) {
    ...
    UTMNCoordinateTransform.prototype.fx = function () {
        var _this = this;
        var result = new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
            var nitfIGEOLO, ZONE_LENGTH, EASTING_LENGTH, NORTHING_LENGTH, COORD_LENGTH, myNewInstance, i, coordinate, parsedZone, parsedEasting, parsedNorthing, nmin, i, i, body, err_1;
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        for (i = 0; i <= 3; i++) {
                            ...
                            parsedZone = coordinate.substr(0, ZONE_LENGTH);
                            parsedEasting = coordinate.substr(ZONE_LENGTH, EASTING_LENGTH);
                            parsedNorthing = coordinate.substr(ZONE_LENGTH + EASTING_LENGTH, NORTHING_LENGTH);
                        ...
                        nmin = myNewInstance.sourceCoordinates[0].sourceNorthing;
                        for (i = 1; i <= 3; i++) {
    ...
    UTMNCoordinateTransform.prototype.callService = function (conversionRequest) {
        var _this = this;
        var result = new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        if (!this._servicePath) {
                            return [2, reject('Invalid Service Path for UTMN Coordinate Service')];
                        }
                        return [4, rp.post({
    ...
    return UTMNCoordinateTransform;
}(_1.BaseTransform));
exports.UTMNCoordinateTransform = UTMNCoordinateTransform;
