        ...
        var result = new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 4, , 5]);
                        isInMemoryObject = _.find(this._defs, { id: id });
                        if (isInMemoryObject) {
                            return [2, resolve(Object.assign({}, isInMemoryObject))];
                        }
                        filePath = path.join(__dirname, 'definitions', id + '.json');
                        return [4, fs.access(filePath, fs.constants.R_OK)];
                    case 2:
                        _a.sent();
                        return [4, fs.readJson(filePath)];
                    case 3:
                        def = _a.sent();
                        this._defs.push(def);
